<template>
  <div>
    <Breadcrumb msg1="基本信息管理" msg2="状态码类别列表" />

    <!-- 卡片视图区域 -->
    <el-card>
      <el-row :gutter="10">
        <el-col :span="10">
          <el-input v-model="queryInfo.name" placeholder="请输入要查的状态码类别名" clearable @clear="getData">
            <el-button slot="append" icon="el-icon-search" @click="getData"></el-button>
          </el-input>
        </el-col>
        <el-col :span="14">
          <el-button type="primary" icon="el-icon-circle-plus-outline" plain @click="add()">添加状态码类别</el-button>
      ...
      >
        ...
        <el-table-column label="状态码类别名" prop="name"></el-table-column>
